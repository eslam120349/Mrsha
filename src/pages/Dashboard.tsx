    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32 }}>
          <div>
            <h1 style={{ fontSize: 22, fontWeight: 700, color: '#f1f5f9', margin: 0 }}>لوحة التحكم</h1>
            <p style={{ fontSize: 13, color: '#64748b', marginTop: 4 }}>الفصل الدراسي الثاني · 2026</p>
          </div>
          <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 24 }}>
          {[
            ...
            },
            {
              ...
              icon: (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ec4899" strokeWidth="1.8" strokeLinecap="round">
            ...
            <div key={i} style={{
              ...
              <div style={{ fontSize: 28, fontWeight: 700, color: '#f1f5f9', lineHeight: 1 }}>{s.value}</div>
              ...
              <div>
                {topStudents.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <span style={{ fontSize: 11, color: '#475569', minWidth: 16, textAlign: 'center' }}>{i + 1}</span>
                    <div style={{
                    ...
                    <span style={{ flex: 1, fontSize: 13, color: '#cbd5e1' }}>{s.full_name}</span>
                    <div style={{ width: 60, height: 4, background: 'rgba(255,255,255,0.08)', borderRadius: 3, overflow: 'hidden' }}>
                      <div style={{ height: '100%', width: `${s.avg}%`, background: 'linear-gradient(90deg, #10b981, #34d399)', borderRadius: 3 }} />
                    </div>
                    <span style={{ fontSize: 12, fontWeight: 600, color: '#34d399', minWidth: 34, textAlign: 'left' }}>{s.avg}%</span>
                  </div>
                ))}
              </div>
            )}
              ...
              <div>
                {weakStudents.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <span style={{ fontSize: 12, fontWeight: 600, color: '#f87171', minWidth: 34, textAlign: 'left' }}>{s.avg}%</span>
                  </div>
                ))}
              </div>
            )}
